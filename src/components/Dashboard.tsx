...
export function Dashboard({ mesActual, productos, ventas, gastos, producciones }: DashboardProps) {
  ...
  const efectivo = ventasMes - datosMes.gastosFab - gastosPersMes;
      ...
      <div className="grid grid-cols-2 gap-3">
        <Card className="bg-white dark:bg-slate-800 border-0 shadow-lg overflow-hidden">
          ...
          <CardContent className="p-4">
            ...
            <p className={`text-lg font-bold ${efectivo >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}`}>
              ₲ {formatMoney(efectivo)}
            </p>
          </CardContent>
        </Card>
